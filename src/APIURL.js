...
const movies_api = {
  movies: `https://api.themoviedb.org/3/discover/movie?api_key=04c35731a5ee918f014970082a0088b1&region=IN&sort_by=release_date.asc&page=${page_no}&&primary_release_year=2024&with_original_language=hi`,
  tv_shows:
